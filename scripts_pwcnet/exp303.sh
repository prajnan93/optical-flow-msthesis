...
#SBATCH --job-name=pwcnet_raft_encoder_no_norm_exp303
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:1
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/pwcnet/outs/exp303.out
...
python train.py --model "PWCNet" \
                ...
                --device "0" \
                --log_dir "../results/pwcnet/logs/exp303" \
                --ckpt_dir "../results/pwcnet/ckpts/exp303" \
                --batch_size 8 \
                --start_iteration 1 \
                --num_steps 1200100 \
