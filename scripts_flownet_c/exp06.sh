...
#SBATCH --job-name=flownet_c_exp06
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:1
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/flownet_c/outs/exp06.out
...
python train.py --model "FlowNetC" \
                ...
                --device "0" \
                --log_dir "../results/flownet_c/logs/exp06" \
                --ckpt_dir "../results/flownet_c/ckpts/exp06" \
                --batch_size 10 \
                --start_iteration 1 \
                --num_steps 100100 \
