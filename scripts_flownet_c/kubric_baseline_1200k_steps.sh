...
#SBATCH --job-name=flownet_c_kubric_baseline_1200k_steps
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a6000:4
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/flownet_c/outs/kubric_baseline_1200k_steps.out
...
python train.py --model "FlowNetC" \
                ...
                --device "all" \
                --log_dir "../results/flownet_c/logs/kubric_baseline_1200k_steps" \
                --ckpt_dir "../results/flownet_c/ckpts/kubric_baseline_1200k_steps" \
                --batch_size 2 \
                --start_iteration 1 \
                --num_steps 1200100 \
