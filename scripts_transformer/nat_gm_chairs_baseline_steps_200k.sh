...
#SBATCH --job-name=nat_gm_chairs_baseline_steps_200k
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:1
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/transformers/outs/nat_gm_chairs_baseline_steps_200k.out
...
python train.py --model "GMFlowV2" \
                ...
                --device "0" \
                --log_dir "../results/transformers/logs/nat_gm_chairs_baseline_steps_200k" \
                --ckpt_dir "../results/transformers/ckpts/nat_gm_chairs_baseline_steps_200k" \
                --batch_size 10 \
                --start_iteration 1 \
                --num_steps 200100 \
