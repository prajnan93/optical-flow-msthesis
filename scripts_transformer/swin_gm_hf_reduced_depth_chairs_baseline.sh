...
#SBATCH --job-name=swin_gm_hf_reduced_depth_chairs_baseline
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:5
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/transformers/outs/swin_gm_hf_reduced_depth_chairs_baseline.out
...
python train.py --model "GMFlowV2" \
                ...
                --device "all" \
                --log_dir "../results/transformers/logs/swin_gm_hf_reduced_depth_chairs_baseline" \
                --ckpt_dir "../results/transformers/ckpts/swin_gm_hf_reduced_depth_chairs_baseline" \
                --batch_size 2 \
                --start_iteration 1 \
                --num_steps 1200100 \
