...
#SBATCH --job-name=perceiver_exp04
#SBATCH --partition=jiang
#SBATCH --mem=368G
#SBATCH --gres=gpu:a6000:8
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/perceiver/outs/exp04.out
...
python train.py --model "Perceiver" \
                ...
                --device "all" \
                --log_dir "../results/perceiver/logs/exp04" \
                --ckpt_dir "../results/perceiver/ckpts/exp04" \
                --batch_size 1 \
                --start_iteration 1 \
                --num_steps 100100 \
