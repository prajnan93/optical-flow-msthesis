...
#SBATCH --job-name=flownet_c_chairs_baseline_2400k_steps
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a6000:4
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/flownet_c/outs/chairs_baseline_2400k_steps.out
...
python train.py --model "FlowNetC" \
                ...
                --device "all" \
                --log_dir "../results/flownet_c/logs/chairs_baseline_2400k_steps" \
                --ckpt_dir "../results/flownet_c/ckpts/chairs_baseline_2400k_steps" \
                --batch_size 2 \
                --start_iteration 1 \
                --num_steps 2400100 \
