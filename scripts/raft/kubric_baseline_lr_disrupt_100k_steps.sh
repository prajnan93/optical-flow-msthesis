...
#SBATCH --job-name=raft_kubric_baseline_lr_disrupt_100k_steps
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:1
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/raft/outs/kubric_baseline_lr_disrupt_100k_steps.out
...
python train.py --model "RAFT" \
                ...
                --device "0" \
                --log_dir "../results/raft/logs/kubric_baseline_lr_disrupt_100k_steps" \
                --ckpt_dir "../results/raft/ckpts/kubric_baseline_lr_disrupt_100k_steps" \
