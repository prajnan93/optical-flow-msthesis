...
#SBATCH --job-name=pwcnet_bugfix_exp12_1
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:1
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/pwcnet_bugfix/outs/exp12_1.out
...
python train.py --model "PWCNetV2" \
                ...
                --device "0" \
                --log_dir "../results/pwcnet_bugfix/logs/exp12_1" \
                --ckpt_dir "../results/pwcnet_bugfix/ckpts/exp12_1" \
                --batch_size 8 \
                --num_steps 100000 \
