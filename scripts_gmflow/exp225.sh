...
#SBATCH --job-name=gmflow_exp225
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:2
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/gmflow/outs/exp225.out
...
python train.py --model "GMFlowV2" \
                ...
                --train_cfg "./configs/gmflow/trainer/kubrics_v2_2.yaml" \
                --device "all" \
                --log_dir "../results/gmflow/logs/exp225" \
                --ckpt_dir "../results/gmflow/ckpts/exp225" \
                --batch_size 5 \
                --start_iteration 1 \
                --num_steps 1200100 \
