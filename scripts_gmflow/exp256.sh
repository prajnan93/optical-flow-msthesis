...
#SBATCH --job-name=gmflow_exp256
#SBATCH --partition=jiang
#SBATCH --mem=24G
#SBATCH --gres=gpu:a5000:1
#SBATCH --cpus-per-task=8
#SBATCH --output=../../results/gmflow/outs/exp256.out
...
python train.py --model "GMFlowV2" \
                ...
                --train_cfg "./configs/gmflow/trainer/kubrics_v3_3.yaml" \
                --device "0" \
                --log_dir "../results/gmflow/logs/exp256" \
                --ckpt_dir "../results/gmflow/ckpts/exp256" \
                --batch_size 10 \
                --start_iteration 1 \
                --num_steps 100100 \
