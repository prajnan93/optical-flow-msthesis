...
from ezflow.modules import BasicBlock, BottleneckBlock
from ezflow.encoder import ENCODER_REGISTRY


@ENCODER_REGISTRY.register()
class BasicEncoderV2(nn.Module):
    """
    ...
    def __init__(
        ...
        super(BasicEncoderV2, self).__init__()
    ...
    def forward(self, x):
        ...
        if self.intermediate_features is True:
            ...
            # out = self.dropout(self.regress_layer(out))
